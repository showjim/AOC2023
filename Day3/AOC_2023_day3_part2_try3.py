...
# Find all valid gears
valid_gears = find_gears(schematic_example)
sum_of_gear_ratios = sum(valid_gears)
print(f"Valid gears found: {valid_gears}")
print(f"Sum of all gear ratios: {sum_of_gear_ratios}")